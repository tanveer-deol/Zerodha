...
function Footer() {
  return (
    ...
    <div className="container border-top mt-5">
      <div className="row mt-5 links-foot">
        <div className="col-3">
          <img src="media/images/logo.svg" style={{ width: "50%" }} />
          <p className="fs-8">©2010 - 2024, Not Zerodha Broking Ltd. All rights reserved.</p>
        </div>
        <div className="col-3">
          <p>Company</p>
          <a href="">About</a>
      ...
      <div className="mt-5  text-muted" style={{fontSize:"10px",margin:"0 40px"}}>
